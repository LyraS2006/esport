                                ...
                                <form action="/register" method="POST" class="my-login-validation">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="kelas" id="kelas" class="form-control" required>
                                            ...
                                            <option style="background-color: #1d2b3a; color: white;" value="1">X
                                            </option>
                                            <option style="background-color: #1d2b3a; color: white;" value="2">XI
                                            </option>
                                            <option style="background-color: #1d2b3a; color: white;" value="3">XII
                                            </option>
                                        </select>
                                        <div class="invalid-feedback">
                                            Kelasnya juga diisi
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="jurusan" id="jurusan" class="form-control" required>
                                            ...
                                            <option style="background-color: #1d2b3a; color: white;" value="1">Bisnis
                                                Digital</option>
                                            <option style="background-color: #1d2b3a; color: white;" value="2">
                                                Manajemen Perkantoran</option>
                                            <option style="background-color: #1d2b3a; color: white;" value="3">
                                                Akuntansi</option>
                                            <option style="background-color: #1d2b3a; color: white;" value="4">Layanan
                                                Perbankan</option>
                                            <option style="background-color: #1d2b3a; color: white;" value="5">Rekayasa
                                                Perangkat Lunak</option>
                                            <option style="background-color: #1d2b3a; color: white;" value="6">Desain
                                                Komunikasi Visual</option>
                                            <option style="background-color: #1d2b3a; color: white;" value="7">Teknik
                                                Komputer Jaringan</option>
                                            <option style="background-color: #1d2b3a; color: white;" value="8">Produksi
                                                dan Siaran Program Televisi</option>
                                            <option style="background-color: #1d2b3a; color: white;" value="9 ">Produksi
                                                Film</option>
                                        </select>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="form-groupp">
                                        ...
                                        <div class="option-radio">
                                            <input class="form-option" type="radio" id="1" name="jenis_kelamin"
                                                value="1" required>
                                            <label for="1">Laki - Laki</label>
                                            <input class="form-option" type="radio" id="2" name="jenis_kelamin"
                                                value="2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="game" id="game" class="form-control" required>
                                            ...
                                            <option style="background-color: #1d2b3a; color: white;" value="ml">Mobile
                                                Legend</option>
                                            <option style="background-color: #1d2b3a; color: white;" value="pubg">PUBG
                                                Mobile</option>
                                            <option style="background-color: #1d2b3a; color: white;" value="ff">Free
                                                Fire</option>
                                        </select>
                                        <div class="invalid-feedback">
                                            Nisn nya isi juga dongg
